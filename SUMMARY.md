...
- [Tools](tools/README.md)
    ...
    - [OBS 虚拟摄像头](tools/obs.md)
    - [Hexo 博客框架](tools/hexo.md)
    - [Scoop - Windows 的命令行软件安装工具](tools/scoop.md)
    - [vercel 静态页面托管](https://vercel.com/) 
    - [PowerShell 美化](https://ohmyposh.dev/)
    - [Frp 内网穿透](https://github.com/fatedier/frp)

- [Git](git/README.md)
    - [git reset - 撤销commit操作](git/reset.md)
    - [git reset - 覆盖分支](git/reset.md#覆盖分支)

- [Kali](kali/README.md)
    - [Kali 网络配置](kali/network.md)
    - [Nmap 常用命令](kali/nmap.md)
